...
ALLOWED_HOSTS = ["*"]  # allow all hosts (Render will manage domain)
...
# Database (use SQLite locally, PostgreSQL in Render)
DATABASES = {
    "default": dj_database_url.config(
        default=os.getenv("DATABASE_URL"),  # Render provides DATABASE_URL
        conn_max_age=600,
        ssl_require=True
    )
}
...
EMAIL_HOST_PASSWORD = 'xzml rgmr zant ppdp'  # Use App Password (not normal password)
